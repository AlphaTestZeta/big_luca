...
- Ogni titolo si muove ogni 20 secondi con una variazione casuale, tarata sulla sua volatilità.
...
- A ogni aggiornamento c'è circa il 6% di probabilità che un titolo abbia un crollo o un boom tra l'8% e il 30%, con la notizia relativa.
- L'amministratore può forzare un evento di qualsiasi percentuale, pubblicare notizie sue ed eliminare quelle che non servono più.
- I grafici hanno una griglia con i valori e, passandoci sopra il mouse (o il dito, su telefono), mostrano il valore esatto e l'orario di quel punto.
...
Nella stessa tabella puoi anche cambiare prezzo e volatilità di un titolo in qualsiasi momento, anche mentre è ritirato: modifica i campi e premi «Salva». Utile per aggiustare un titolo troppo tranquillo o troppo instabile senza doverlo eliminare e ricreare.
...
| `TICK_MS` | ogni quanto si muovono i prezzi (20000 = 20 secondi) |
| `MAX_RECUPERO` | quanti aggiornamenti di assenza vengono recuperati |
